...
#
# Használat:  ./launch-soundsculpture.sh
#
set -euo pipefail
...
HTML_FILE="$SCRIPT_DIR/AudioFOrge zeroHour Mobil verzió v1.1 jó a wav (4. másolat).html"

if [ ! -f "$HTML_FILE" ]; then
  HTML_FILE="$SCRIPT_DIR/AudioFOrge zeroHour Mobil verzió v1.1 jó a wav.html"
fi
